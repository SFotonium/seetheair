// Version v0.2b - SPECSensor NO2 data logger
...
// SPEC_Data_read();
  ...
  if (buffer_index >= buffer_length){
    buffer_ok = 1; // we filled the buffer = we have enough data to compute the median
    buffer_index = 0;
  }
